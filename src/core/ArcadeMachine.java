...
public class ArcadeMachine {
    ...
    {
    	VGDLFactory.GetInstance().init(); // initialize actions, affects and their calsses,  This always first thing to do.
    	VGDLRegistry.GetInstance().init();//

	if (VERBOSE) System.out.println(" ** Playing game " + game_file + ", level " + level_file + " **");

...
public class SharedData {
	 ...
	 */
	public static final int POPULATION_SIZE = 50-45; //remove 45
	
	public static  double ITERATION_NOVELTY = 0; //novelty for each iteration
	 ...
	 * minimum level size
	 */
	public static final double MIN_SIZE = 14; //4
	/**
	 * maximum level size
	 */
	public static final double MAX_SIZE = 14;  //18
	/**
